# 🏨 Airbnb Data Project: End-to-End (E2E) Data Pipeline with AWS S3, Snowflake, dbt & Power BI / Preset

## 🚀 Project Overview

This repository contains a complete **End-to-End (E2E)** Data Engineering and Data Analytics project that covers the entire data lifecycle. The project transforms raw data into actionable insights by covering Data Ingestion, Data Transformation, Data Modeling and Data Visualization, using a modern data stack, and real-world **Airbnb data** (focusing on `listings`, `hosts`, and `reviews`).

The goal of this project is to showcase scalable data modeling, rigorous data quality testing, cloud warehouse management, and advanced business intelligence integrations.
...
The following Directed Acyclic Graph (DAG) generated by dbt Core illustrates the complete data flow. It maps the transformation journey from the raw Snowflake sources, through the staging models (Bronze/Silver), down to the final dimensional marts (Gold) ready for Power BI consumption:
...
├── docs/                    # Screenshots of Lineage graphs (DAG), dbt docs and Snowflake Workspace & Database Explorer
